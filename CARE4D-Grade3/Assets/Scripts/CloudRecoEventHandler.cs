...
//	public VideoPlaybackIcon VideoPlaybackIcon;
...
//			PlayerPrefs.SetString ("myURL", null);
            return;
        }
		...
		JSONObject jsonMeta = new JSONObject(targetSearchResult.MetaData);
		//Set Video Player Icon
//		ErrorText.instance.AddErrorText("Initializing Thumbnail " + "CAREVideoThumbs/" + jsonMeta["name"].ToString());
//		(jsonMeta["name"].ToString());
//		VideoPlaybackIcon.m_path = jsonMeta["url"].ToString();
//		Video.m_strFileName = jsonMeta["url"].ToString();
//		ErrorText.instance.AddErrorText(jsonMeta["url"].ToString());
//		ErrorText.instance.AddErrorText(jsonMeta["name"].ToString());

		String theuglyURL = jsonMeta["url"].ToString();
		String cleanURL;
		cleanURL = theuglyURL.Replace("\\","").Replace("\"","");

		PlayerPrefs.SetString ("myURL", cleanURL); //jsonMeta["name"].ToString());
//		Debug.Log ("myURL: " + cleanURL);//jsonMeta ["name"].ToString ());
